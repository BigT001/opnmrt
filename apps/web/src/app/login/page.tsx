...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-500">
            <LandingBackground />
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-4xl font-black text-foreground tracking-tighter uppercase">Merchant Portal</h2>
                ...
                <motion.div
                    ...
                    className="bg-card/80 backdrop-blur-3xl py-12 px-8 shadow-2xl rounded-[3rem] border border-border sm:px-12"
                >
                    <form className="space-y-8" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="flex items-center justify-between px-1">
                            <label className="flex items-center space-x-3 cursor-pointer group">
                                <div className="relative">
                                    ...
                                    <div className="w-5 h-5 bg-muted border-2 border-border rounded-lg peer-checked:bg-emerald-500 peer-checked:border-emerald-500 transition-all" />
                                ...
                                <span className="text-xs font-bold text-muted-foreground uppercase tracking-widest group-hover:text-foreground transition-colors">Persistent Session</span>
                            </label>
                        </div>
                        ...
                        <button
                            ...
                            className="w-full h-14 bg-emerald-500 hover:brightness-110 text-white font-black rounded-2xl shadow-xl shadow-emerald-500/20 transition-all disabled:opacity-50 uppercase tracking-widest text-sm flex items-center justify-center space-x-2"
                        >
                            {isSubmitting ? (
                                <>
    ...
    return (
        <div>
            ...
            <input
                ...
                className="w-full h-14 px-5 bg-muted/30 border border-border rounded-2xl focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 text-foreground font-bold transition-all outline-none placeholder:text-muted-foreground/20"
            />
